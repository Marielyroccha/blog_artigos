...
class Artigo 
{
    ...
    public function exibirTodos(): array
    {
        ...
        $resultado = $this->mysql->query('SELECT id, Imagem, titulo, conteudo FROM artigos');
    ...
    {
        $selecionaArtigo = $this->mysql->prepare("SELECT id, Imagem, titulo, conteudo FROM artigos WHERE id = ? ");
